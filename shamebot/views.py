...
def help_text(app: "App") -> list[str]:
    ...
    intro = (
        ...
        + (f"🏆 **Wall of Fame** — **{s.glory_kills}+ kills**{ace} (15+ kills), or a hard carry: best on the team with {s.fame_carry_share}%+ of its output, {s.fame_carry_kills}+ kills with K/D ≥ {s.fame_carry_kd} or ADR ≥ {s.fame_carry_adr:.0f} (on a loss: top-fragger of the lobby too). Two of you carrying a win together = **Duo carry**.\n" if s.glory_posts_enabled else "")
    ...
    buttons = (
        ...
        "Fame awards: 👑 Top of the lobby · 🚂 Hard carry · 🤝 Duo carry · 🃏 Ace · 🧊 Clutch king · 🚀 Entry king · 🧪 Utility master · ⭐ MVP machine\n\n"
        "## Titles (last {n} games)\n"
